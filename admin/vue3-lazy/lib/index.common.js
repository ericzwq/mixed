...
// CONCATENATED MODULE: ./packages/types.ts
var Status;
...
// CONCATENATED MODULE: ./packages/listen.ts
...
var directiveConfig = Object.assign(baseConfig, {
  src: '',
  lazyKey: 'default',
  loaded: false
});
...
function findVmSet(target) {
  ...
  try {
    for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
      ...
      if (!lazyVmSet.size) continue; // let el
...
// CONCATENATED MODULE: ./packages/LazyComponent.tsx





/* harmony default export */ var LazyComponent = (Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
  render: function render() {
    ...
    if (!this.loaded) {
      ...
      return this.$slots.loading ? Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])('div', this.$slots.loading()) : Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("div", null, null);
    } else {
      return this.$slots.default ? Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])('div', this.$slots.default()) : Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("div", null, null);
    }
  },
  props: ['lazyKey'],
  setup: function setup() {
    ...
    Object(external_commonjs_vue_commonjs2_vue_root_Vue_["onBeforeUnmount"])(function () {
      var _iterator = _createForOfIteratorHelper(lazyVmMap),
          _step;
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (vmSet.delete((_getCurrentInstance = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["getCurrentInstance"])()) === null || _getCurrentInstance === void 0 ? void 0 : _getCurrentInstance.proxy)) {
            data.componentTotal--;
            data.componentCount--;
          }
        }
    ...
    var loaded = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(false);
    return {
      loaded: loaded
    };
  }
...
// CONCATENATED MODULE: ./packages/LazyDirective.ts
...
/* harmony default export */ var LazyDirective = ({
  beforeMount: function beforeMount(el, _ref) {
    ...
    if (typeof value === 'string') {
      el.lazy = Object.assign(_objectSpread2({}, directiveConfig), {
        src: value
      });
    } else {
      var _el$classList;
      ...
      (_el$classList = el.classList).add.apply(_el$classList, _toConsumableArray(loadingClassList));

      if (value.lazyKey != null) key = value.lazyKey;
      el.lazy = Object.assign(_objectSpread2({}, directiveConfig), value);
    }
  ...
  updated: function updated(el) {
    if (el.getAttribute('status') !== Status.loading) return;
    setTimeout(function () {
      if (inViewPort(el)) updateDirectiveEl(el);
    });
  },
  beforeUnmount: function beforeUnmount(el) {
    var _iterator = _createForOfIteratorHelper(lazyElMap),
        _step;
